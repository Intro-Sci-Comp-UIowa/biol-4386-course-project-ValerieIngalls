...
Attempts to normalize the distribution of zinc seem to have made it more skewed rather than less skewed; therefore we will continue with the original measure. However, the Box-Cox normalizing transformation shows less skewness in our measurements of copper, so we will move forward with that transformation.


```{r appendNorm}
zinc_final <- zinc_subset %>%
  mutate("normedCopper" = normed_copper)
```
