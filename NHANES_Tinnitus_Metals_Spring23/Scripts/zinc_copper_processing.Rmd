...
# refator, compute, combine for various variables
  mutate(
         ...
         "tinnitus_type" = if_else(tinnitus_duration == 1 & tinnitus_severity == 1, 1, 
                                   if_else(!is.na(tinnitus_duration) | !is.na(tinnitus_severity), 2, 3)),
# 1: bothersome chronic, 2: not bothersome or not chronic, 3: no tinnitus
