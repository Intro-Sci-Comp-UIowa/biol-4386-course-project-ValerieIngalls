...
lmzn_normed <- svyglm(normedZinc ~ tinnitus_type + age_group + ethnicity + sex, design = tinnitus_design)
summary(lmzn_normed)


lmcu_normed <- svyglm(normedCopper ~ tinnitus_type + age_group + ethnicity + sex, design = tinnitus_design)
summary(lmcu_normed)

```


Normalized data shows no differences in associations as compared to the directly measured zinc and copper values. We will still use it as the lower skew adds validity to our statistical measures.
