...
# proof of concept
#ggplot() +
#  geom_histogram(data = df[df$tinnitus_type == 1,], mapping = aes(x = zinc)) +
#  geom_histogram(data = df[df$tinnitus_type == 2,], mapping = aes(x = zinc)) +
#  geom_histogram(data = df[df$tinnitus_type == 3,], mapping = aes(x = zinc))
```
...
```{r}
par(mfrow = c(1, 2))
svyhist(~zinc, design = tinnitus_design, breaks = 30)
hist(df$zinc, freq = FALSE, breaks = 30)

par(mfrow = c(1, 2))
svyhist(~copper, design = tinnitus_design, breaks = 30)
hist(df$copper, freq = FALSE, breaks = 30)
...
ggplot() +
  geom_histogram(data = ct, mapping = aes(x = zinc, weight = ctweight), stat = "density", color = 2, alpha = .7) +
  geom_histogram(data = at, mapping = aes(x = zinc, weight = atweight), stat = "density", color = 3, alpha = .7) +
  geom_histogram(data = nt, mapping = aes(x = zinc, weight = ntweight), stat = "density", color = 4, alpha = .7)

ggplot() +
  geom_histogram(data = ct, mapping = aes(x = copper, weight = ctweight), stat = "density", color = 2, alpha = .7) +
  geom_histogram(data = at, mapping = aes(x = copper, weight = atweight), stat = "density", color = 3, alpha = .7) +
  geom_histogram(data = nt, mapping = aes(x = copper, weight = ntweight), stat = "density", color = 4, alpha = .7)
