...
```{r}
zn_def_logit <- svyglm(zinc_deficiency ~ tinnitus_type + age_group + ethnicity + sex + speech_in_noise, design = tinnitus_design, family = "quasibinomial")
summary(zn_def_logit)


cu_def_logit <- svyglm(copper_deficiency ~ tinnitus_type + age_group + ethnicity + sex + speech_in_noise, design = tinnitus_design, family = "quasibinomial")
